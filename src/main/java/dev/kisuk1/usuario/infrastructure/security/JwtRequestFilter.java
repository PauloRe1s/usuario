package dev.kisuk1.usuario.infrastructure.security;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    // Construtor que inicializa as propriedades com instâncias fornecidas - 'Injeção'
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            ...
            final String emailToken = jwtUtil.extractEmail(token);
            ...
            if (emailToken != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                // Valida o token JWT
                if (jwtUtil.validateToken(token, emailToken)) {
